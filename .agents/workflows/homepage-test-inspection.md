...
10. 결과를 `output/inspection-summary_YYYY-MM-DD.md`, `output/inspection-details_YYYY-MM-DD.csv`, `output/recency-status_YYYY-MM-DD.csv`에 작성한다.
11. 점검하지 못한 페이지와 이유를 `output/unvisited-pages_YYYY-MM-DD.md`에 기록한다.
